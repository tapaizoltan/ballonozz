...
INSERT INTO `coupons` VALUES (1,1,'','Meglepkék',2,0,0,0,0,NULL,NULL),(2,1,'','Meglepkék',2,2,0,0,0,NULL,NULL),(3,1,'','RH Sound',1,0,0,0,0,NULL,NULL);
...
CREATE TABLE `passengers` (
  ...
  `body weight` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'testsúly',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`)
...
INSERT INTO `passengers` VALUES (1,'m123456','Katalin','Tápai','1984-02-09','972232TA','64',NULL,NULL);
...
-- Dump completed on 2024-03-19 16:23:55
